...
if __name__ == "__main__":
    ...
    trainset = torchvision.datasets.ImageFolder(root='G:\\DIV2K-train', transform=transform_train)
    trainloader = torch.utils.data.DataLoader(trainset, batch_size=16, shuffle=True, num_workers=8)

    testset = torchvision.datasets.ImageFolder(root='G:\\DIV2K-test', transform=transform_train)
    testloader = torch.utils.data.DataLoader(testset, batch_size=16, shuffle=False, num_workers=4)
    classes = ('DIV2K_train_HR', 'DIV2K_train_LR_aniso_blur', 'DIV2K_train_LR_bicubic_X2',
               'DIV2K_train_LR_bicubic_X3, DIV2K_train_LR_bicubic_X4',
               'DIV2K_train_LR_iso_blur', 'DIV2K_train_LR_noise_15', 'DIV2K_train_LR_noise_30',
               'DIV2K_train_LR_noise_50')
